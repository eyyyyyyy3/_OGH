...
static struct client_textmessage_t;
static struct CSentence;
static struct CAudioSource;
static struct ISpatialQuery;
static struct IMaterialSystem;
static struct AudioState_t;
static struct Frustum_t;
static struct INetChannelInfo;
static struct CPhysCollide;
static struct IAchievementMgr;
static struct ISPSharedMemory;
static struct pfnDemoCustomDataCallback;
static struct CGamestatsData;
...
public:
	...
	virtual void                  SolidMoved(class BaseEntity* pSolidEnt, class ICollideable* pSolidCollide, const Vector* pPrevAbsOrigin, bool accurateBboxTriggerChecks) = 0;
	virtual void                  TriggerMoved(class BaseEntity* pTriggerEnt, bool accurateBboxTriggerChecks) = 0;
